...
class Serve(BaseServe):
    ...
    def __init__(
        ...
        api_prefix: Optional[str] = "/api/v1/system-config",
    ...
    def before_start(self):
        ...
        # Import entity to ensure table creation
        from .models.models import SystemConfigEntity as _  # noqa: F401
