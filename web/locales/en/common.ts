export const CommonEn = {
  ...
  home_slogan: 'Ask Data, Predict Insights',
  skills: 'Skills',
  datasources: 'Datasources',
  knowledge: 'Knowledge Base',
  management: 'Management',
  app_management: 'App Management',
  awel_workflow: 'Workflow',
  prompts: 'Prompts',
  // Skills page
  ...
  Admin_Login_Name_Required: 'Please input login name',
  Admin_Password: 'Password',
  Admin_Password_Required: 'Please input password',
  Admin_Real_Name_Label: 'Real Name',
  Admin_Email_Label: 'Email',
  Admin_Phone_Label: 'Phone',
  Admin_Department: 'Department',
  Admin_Department_Placeholder: 'Please select department',
  Admin_Role: 'Role',
  Admin_Role_Placeholder: 'Please select role',
  Admin_Active: 'Active',
  ...
  Edit_Role: 'Edit Role',
  Role_Code: 'Role Code',
  Role_Code_Required: 'Please input role code',
  Role_Name: 'Role Name',
  Role_Name_Required: 'Please input role name',
  Role_Description: 'Description',
  Role_Description_Placeholder: 'Please input description',
  Assign_Permissions: 'Assign Permissions',
  No_Permission_Data: 'No permission data',
  Delete_Confirm: 'Confirm Delete',
  Delete_Role_Confirm: 'Are you sure you want to delete role "{{name}}"?',
  Delete_Success: 'Delete success',
  Delete_Failed: 'Delete failed',
  Role_Code_Exists: 'Role code already exists',
  Role_Not_Found: 'Role not found',
  // Registration
  Registration_Audit: 'Pending Users',
  Approve: 'Approve',
  Reject: 'Reject',
  Approved: 'Approved',
  Rejected: 'Rejected',
  ...
  Dept_Code_Required: 'Please input department code',
  Dept_Name: 'Department Name',
  Dept_Name_Required: 'Please input department name',
  Parent_Dept: 'Parent Department',
  Parent_Dept_Placeholder: 'Please select parent department',
  Dept_Leader: 'Leader',
  Dept_Phone: 'Phone',
  Dept_Delete_Confirm: 'Are you sure you want to delete department "{{name}}"?',
  Dept_Not_Found: 'Department not found',
  Dept_Has_SubDepts: 'Cannot delete department with sub-departments',
  // Permission
  ...
  // Messages
  Load_User_Failed: 'Failed to load users',
  Load_Role_Failed: 'Failed to load roles',
  Load_Dept_Failed: 'Failed to load departments',
  Load_User_Roles_Failed: 'Failed to load user roles',
  Load_Permission_Failed: 'Failed to load permissions',
  Load_Role_Permissions_Failed: 'Failed to load role permissions',
  User_ID_Exists: 'User ID or login name already exists',
  User_Not_Found: 'User not found',
  Operation_Failed: 'Operation failed',
  // Table
  Total_Records: '共 {{total}} 条',
  // Registration page
  Load_Registration_Failed: 'Failed to load registration applications',
  Registration_Reject_Reason: 'Reject Reason',
  Registration_Apply_Time: 'Apply Time',
  Registration_Status_Filter: 'Status Filter',
  Registration_All: 'All',
  Registration_Processed: 'Processed',
  Registration_Approve_Title: 'Approve',
  Registration_Reject_Title: 'Reject',
  // Dept page
  Dept_Management: 'Department Management',
  Dept_Sort: 'Sort',
  Dept_Sort_Placeholder: 'Please input sort value',
  // Permission page
  ...
  real_name: 'Real Name',
  please_input_real_name: 'Please input real name',
  email: 'Email',
  ...
  please_input_old_password: 'Please input current password',
  ...
  password_req_length: '• At least 6 characters',
  password_req_suggest: '• Suggest including uppercase, lowercase, numbers and special characters',
  password_req_unique: '• Do not use the same password as other websites',
